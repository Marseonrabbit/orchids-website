...
const Home = () => (
    <div className="relative w-full min-h-screen text-foreground bg-background overflow-x-hidden selection:bg-accent selection:text-white font-poppins">
    <Navbar />
    <ScrollIndicator />
    ...
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-accent/[0.05] rounded-full blur-[120px]" />
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
        ...
        <div className="z-10 flex flex-col items-center flex-grow justify-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-6">
            <a href="#services" className="px-10 py-4 bg-accent text-white rounded-full font-bold uppercase text-[10px] tracking-[0.2em] shadow-[0_0_30px_rgba(46,16,101,0.6)] hover:opacity-90 transition-all duration-300">
              Explore Services
            </a>
            <a href="#about" className="px-10 py-4 border border-accent/20 rounded-full font-bold uppercase text-[10px] tracking-[0.2em] hover:bg-accent/10 transition-all duration-300">
              Our Story
            </a>
            </div>
          </div>
