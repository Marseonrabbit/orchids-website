        ...
        <div className="flex-1">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                <div className="w-12 h-12 rounded-2xl bg-foreground/5 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500">
          ...
          <div className="flex-1">
            <motion.form 
              ...
              transition={{ duration: 0.8 }}
              className="bg-foreground/[0.02] border border-border/5 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-sm"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input type="email" className="bg-foreground/5 border border-border/10 rounded-2xl px-6 py-4 focus:outline-none focus:border-primary transition-all text-foreground" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 mb-8">
                ...
                <textarea rows={5} className="bg-foreground/5 border border-border/10 rounded-3xl px-6 py-4 focus:outline-none focus:border-primary transition-all resize-none text-foreground"></textarea>
              </div>
              <button className="w-full py-5 bg-primary text-primary-foreground rounded-full font-bold uppercase text-xs tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-darkPurple hover:text-white transition-all shadow-[0_0_30px_rgba(46,16,101,0.3)]">
