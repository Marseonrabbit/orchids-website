          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  <div className="w-12 h-12 rounded-2xl bg-foreground/5 flex items-center justify-center group-hover:bg-darkPurple transition-all duration-500 text-foreground group-hover:text-white">
            ...
            <div className="flex-1">
              ...
              >
                ...
                <button className="w-full py-5 bg-darkPurple text-white rounded-full font-bold uppercase text-xs tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-black hover:text-white transition-all shadow-[0_0_30px_rgba(46,16,101,0.5)]">
