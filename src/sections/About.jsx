          ...
          >
            {t.tag}
              ...
              <h2 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-8 font-montserrat tracking-tighter text-foreground">
                {t.title} <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-darkPurple to-primary italic font-playfair font-normal dark:from-white dark:via-darkPurple dark:to-white">
                  {t.subtitle}
                </span>
              </h2>
