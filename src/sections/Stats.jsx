...
const Stats = ({ lang }) => {
  const t = {
    ...
    return (
      <div className="py-24 bg-background border-y border-foreground/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
          {t.map((stat, idx) => (
            ...
            >
              ...
              <div className="text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] text-foreground/40 font-montserrat group-hover:text-foreground transition-colors">
                {stat.label}
              </div>
            </motion.div>
          ))}
