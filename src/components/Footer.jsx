...
const Footer = ({ lang }) => {
  const t = {
    ...
    return (
      <footer className="bg-background text-foreground pt-24 pb-12 px-6 md:px-12 border-t border-foreground/5">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center">
                  <img 
                    ...
                    alt="Skylumine Logo" 
                    className="h-16 md:h-20 w-auto object-contain mix-blend-difference dark:mix-blend-screen"
                  />
                </div>
                <p className="text-foreground/40 text-sm leading-relaxed max-w-xs font-poppins mt-2">
                {t.about}
              </p>
            <div className="flex gap-4 mt-2">
              {[Instagram, Twitter, Linkedin, Facebook].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full border border-foreground/10 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all duration-300">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm text-foreground/40 font-poppins">
            ...
            <div className="flex flex-col gap-4">
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-foreground/5 border border-foreground/10 rounded-full px-6 py-3 text-sm focus:outline-none focus:border-primary transition-colors font-poppins text-foreground"
                />
                <button className="absolute right-1.5 top-1.5 px-6 py-1.5 bg-primary text-primary-foreground rounded-full text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-all">
                  {t.subscribe}
                </button>
              </div>
              <div className="flex flex-col gap-4 mt-4 text-sm text-foreground/40 font-poppins">
        ...
        <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-foreground/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-[0.2em] text-foreground/50 font-montserrat">
