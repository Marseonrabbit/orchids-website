    ...
    >
      <div className="flex items-center gap-2">
          <a href="/" className="block overflow-hidden">
              <img 
                  ...
                  alt="Skylumine Logo" 
                      className="h-14 md:h-18 lg:h-24 w-auto object-contain dark:mix-blend-screen scale-[1.8]"
                />
          </a>
      </div>
      ...
      <div className="hidden lg:flex gap-10 text-[11px] font-semibold uppercase tracking-[0.2em] font-montserrat text-muted-foreground">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <a href="#contact" className="hidden sm:block px-8 py-2.5 bg-darkPurple text-white rounded-full hover:bg-darkPurple/90 transition-all duration-500 uppercase text-[10px] font-bold tracking-[0.2em] shadow-[0_0_20px_rgba(46,16,101,0.5)]">
        ...
        >
          ...
          {navLinks.map((link) => (
            <a 
              ...
              href={link.href} 
              onClick={() => setMobileMenuOpen(false)}
              className="text-3xl font-bold uppercase tracking-widest font-montserrat hover:text-darkPurple transition-colors"
            >
              {link.name}
            </a>
          ))}
