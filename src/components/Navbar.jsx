        ...
        >
          ...
          <div className="hidden lg:flex gap-10 text-[11px] font-semibold uppercase tracking-[0.2em] font-montserrat text-muted-foreground">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              <a href="/get-quote" className="hidden sm:block px-8 py-2.5 bg-primary text-primary-foreground rounded-full hover:bg-darkPurple transition-all duration-500 uppercase text-[10px] font-bold tracking-[0.2em] shadow-[0_0_20px_rgba(46,16,101,0.2)]">
                {lang === 'en' ? "Get a Quote" : 'उद्धरण प्राप्त करें'}
              </a>
            ...
            {navLinks.map((link, i) => (
              ...
              >
                ...
                <motion.a 
                  ...
                  href="/get-quote" 
                  onClick={() => setMobileMenuOpen(false)}
                  className="mt-8 px-12 py-4 bg-primary text-primary-foreground rounded-full font-bold uppercase text-xs tracking-[0.2em]"
                >
                  {lang === 'en' ? "Get a Quote" : 'उद्धरण प्राप्त करें'}
                </motion.a>
              </motion.div>
